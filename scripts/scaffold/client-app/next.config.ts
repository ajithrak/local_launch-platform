...
const nextConfig: NextConfig = {
  ...
  // (@locallaunch/gym-kit, theme-engine, ui, config-schema) via workspace
  // symlinks. Without pointing tracing at the actual monorepo root, Next's
  // output file tracing can fail to include those packages' files in the
  // deployed function — the build succeeds locally but Vercel's deploy step
  // fails right after "Collecting build traces...".
