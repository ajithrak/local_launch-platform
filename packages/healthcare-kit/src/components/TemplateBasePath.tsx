...
/** The current template's base path (e.g. "/mednova"), for building internal links. */
...
/**
 * Prefix for raw <img> src paths pointing into /public — e.g. "/clinic" when
 * the app is deployed under Next's `basePath` config, empty for single-client
