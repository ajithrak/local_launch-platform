...
import { Clock, Facebook, Instagram, MapPin, Phone, PhoneCall, Youtube } from 'lucide-react';
...
export function Footer({ business, emergencyPhone }: { business: BusinessInfo; emergencyPhone?: string }) {
        ...
        <div>
          ...
          {emergencyPhone && (
            <a
              ...
              className="mt-1 flex items-center gap-2 text-sm font-semibold hover:underline"
              style={{ fontFamily: 'var(--font-body)', color: 'var(--color-accent)' }}
            >
              <PhoneCall size={13} /> Emergency: {emergencyPhone}
            </a>
          )}
